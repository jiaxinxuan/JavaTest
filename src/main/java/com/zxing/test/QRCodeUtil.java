...
public class QRCodeUtil {  
    ...
    public static void main(String[] args) throws Exception {    
        String text = "http://www.jiaxiaoxuan.top";
        //logo内嵌至二维码中
//        QRCodeUtil.encode(text, "D://233.png", "D://12.jpg", false,600);
        //只有二维码
//        QRCodeUtil.encode(text,"D://1.jpg");
        QRCodeUtil.encode(text,"D://233.png","D://2.jpg",true);
